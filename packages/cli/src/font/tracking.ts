...
export function readManifest(projectRoot: string): FontManifest {
	...
	try {
		...
		if (typeof parsed === "object" && parsed !== null && typeof parsed.fonts === "object" && parsed.fonts !== null) {
			return parsed;
		}
		return { fonts: {} };
	} catch {
...
export function addFont(projectRoot: string, slug: string, family: string, subsets: string[]): void {
