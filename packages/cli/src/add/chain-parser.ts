import { skipStringOrComment } from "@lovrozagar/flare/generators";
 ...
 */
export function findInsertionPoint(source: string, virtualPath: string, methodName: string): InsertionResult | null {
