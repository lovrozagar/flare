 ...
 */
export function registerFormActionContextGetter(
	getter: (fnId: string) => FormActionContext | undefined,
): void {
...
export function Form<TInput, TOutput>(props: FormProps<TInput, TOutput>): JSX.Element {
	const [local, rest] = splitProps(
		props as FormOwnProps<TInput, TOutput> & Record<string, unknown>,
		["action", "children", "enctype", "onError", "onSuccess"],
	)
	...
	const ssrCtx =
		typeof window === "undefined" && _getFormActionContext
			? _getFormActionContext(fnId())
			: undefined
