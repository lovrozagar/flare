...
function localeAllowsConsume(paramName: string, decoded: string, localeMatch?: LocaleMatch): boolean {
	return !localeMatch || paramName !== localeMatch.paramName || localeMatch.locales.includes(decoded);
}
