...
export interface ErrorRenderProps<TParams = Record<string, string>, TSearch = Record<string, string>> {
	error: Error;
...
export interface NotFoundRenderProps<TParams = Record<string, string>, TSearch = Record<string, string>> {
	location: Location<TParams, TSearch>;
}

export interface UnauthenticatedRenderProps<TParams = Record<string, string>, TSearch = Record<string, string>> {
	error: UnauthenticatedError;
	location: Location<TParams, TSearch>;
	retry: () => void;
}

export interface UnauthorizedRenderProps<TParams = Record<string, string>, TSearch = Record<string, string>> {
 ...
 */
export function findErrorBoundary(routes: BoundaryRoute[], errorRouteIndex: number): ErrorRenderFn | null {
 ...
 */
export function findNotFoundBoundary(routes: BoundaryRoute[], throwRouteIndex: number): NotFoundRenderFn | null {
