...
export const notoSansArabic: Font<"arabic" | "latin" | "latin-ext" | "math" | "symbols"> =
	createRegistryFont({
		category: "sans-serif",
		fallbackMetrics: {
		...
		subsetEntries: [
			{
				...
				url: "/fonts/noto-sans-arabic/arabic.woff2",
				weight: "100 900",
			},
			{
				style: "normal",
				...
				url: "/fonts/noto-sans-arabic/math.woff2",
				weight: "100 900",
			},
			{
				style: "normal",
				...
				url: "/fonts/noto-sans-arabic/symbols.woff2",
				weight: "100 900",
			},
			{
				style: "normal",
				...
				url: "/fonts/noto-sans-arabic/latin-ext.woff2",
				weight: "100 900",
			},
			{
				style: "normal",
				...
				url: "/fonts/noto-sans-arabic/latin.woff2",
				weight: "100 900",
			},
		],
