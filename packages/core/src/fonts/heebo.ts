...
export const heebo: Font<"hebrew" | "latin" | "latin-ext" | "math" | "symbols"> =
	createRegistryFont({
		category: "sans-serif",
		fallbackMetrics: {
		...
		subsetEntries: [
			...
			},
			{
				...
				url: "/fonts/heebo/latin-ext.woff2",
				weight: "100 900",
			},
			{
				style: "normal",
