...
export function isStaticImage(src: StaticImageData | string | null | undefined): src is StaticImageData {
...
export function Image(props: ImageProps): JSX.Element {
	...
	const layoutStyles = createMemo(() => {
		...
		if (m === "responsive" && !eff.maxHeight && !eff.aspectRatio) {
			warn("image", "responsive Image without maxHeight or aspectRatio — no layout shift prevention");
		}
