...
function mergeCustom(
	parent: CustomHeadConfig | undefined,
	child: CustomHeadConfig | undefined,
): CustomHeadConfig {
...
export function mergeHeadConfigs(
	...
	for (const key of Object.keys(child)) {
		...
		if (key === "custom") {
			result.custom = mergeCustom(
				parentVal as CustomHeadConfig | undefined,
				childVal as CustomHeadConfig | undefined,
			)
