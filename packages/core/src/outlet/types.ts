...
export interface FlareRouter {
	...
	useLoaderData: <TPath extends RouteVirtualPaths>(options: {
		from: TPath
	...
	useParams: <TPath extends RouteVirtualPaths>(options: {
		from: TPath
	...
	useSearch: <TPath extends RouteVirtualPaths>(options: {
		from: TPath
