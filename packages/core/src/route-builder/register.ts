...
export type ResolvedServerContext = FlareRegister extends { serverContext: infer SC } ? SC : Record<string, unknown>;
...
export type InferAuthMode<T> = T extends { authenticateMode: infer M extends AuthenticateMode } ? M : false;
...
export type RoutePaths = "routes" extends keyof FlareRegister ? keyof RegisteredRoutes & string : string;
...
export type ParentPreloaderContext<TPath extends string> = TPath extends keyof RegisteredRouteParents
	? RegisteredRouteParents[TPath] extends readonly string[]
