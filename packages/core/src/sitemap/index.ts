...
export function filterSitemapRoutes(defs: RouteDefinition[], exclude?: string[]): RouteDefinition[] {
...
export function buildSitemapEntries(defs: RouteDefinition[], config: SitemapConfig): SitemapEntry[] {
...
export function buildSitemapFromDefs(defs: RouteDefinition[], config: SitemapConfig): SitemapResult {
