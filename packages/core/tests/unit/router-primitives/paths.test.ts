...
describe("deriveLayouts", () => {
	...
	it("bare param segments form layout boundaries", () => {
		...
		expect(deriveLayouts("_root_/[locale]/[slug]")).toEqual(["_root_", "_root_/[locale]", "_root_/[locale]/[slug]"]);
	});
	...
	it("pre-root: post-root params still form boundaries", () => {
		expect(deriveLayouts("[locale]/_root_/[slug]")).toEqual(["[locale]", "[locale]/_root_", "[locale]/_root_/[slug]"]);
	});
