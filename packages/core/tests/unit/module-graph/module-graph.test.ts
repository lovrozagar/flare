...
describe("resolveModulePreloads", () => {
	...
	it("follows the hydrate dynamic import from the client entry", () => {
		const manifest = {
			"src/client.tsx": {
				dynamicImports: ["../../packages/core/src/hydrate/index.tsx", "src/routes/about.tsx"],
...
describe("resolveRoutePreloads", () => {
	...
	it("deduplicates across multiple routes", () => {
		const result = resolveRoutePreloads(MANIFEST, ["src/routes/_root_.tsx", "src/routes/index.tsx"], entryPreloads);
		/* root.js, index.js, shared-a.js, shared-b.js — all unique */
		expect(result.js).toEqual(["/assets/root.js", "/assets/index.js", "/assets/shared-a.js", "/assets/shared-b.js"]);
	});
