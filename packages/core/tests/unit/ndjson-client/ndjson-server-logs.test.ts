...
describe("ndjson-client log message handling", () => {
	it("forwards server log to console.log", async () => {
		...
		expect(logSpy).toHaveBeenCalledWith("%c[server]", "color:#60a5fa;font-weight:bold", "hello from server");
	...
	it("forwards server warn to console.warn", async () => {
		...
		expect(warnSpy).toHaveBeenCalledWith("%c[server]", "color:#60a5fa;font-weight:bold", "watch out");
	...
	it("forwards server error to console.error", async () => {
		...
		expect(errorSpy).toHaveBeenCalledWith("%c[server]", "color:#60a5fa;font-weight:bold", "something broke");
