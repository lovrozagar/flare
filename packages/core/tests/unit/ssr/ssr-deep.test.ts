...
import { deriveStatus, mergeHeadConfigs, mergeResponseHeaders, serializeFlareState } from "../../../src/ssr/index.tsx";
...
describe("mergeResponseHeaders deep", () => {
	it("same key: child wins", () => {
		const result = mergeResponseHeaders({ "Cache-Control": "no-cache", "X-Custom": "parent" }, { "X-Custom": "child" });
