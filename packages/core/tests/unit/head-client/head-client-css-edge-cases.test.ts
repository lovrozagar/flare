...
describe("CSS lifecycle: refcount edge cases", () => {
	it("three routes share same stylesheet — refcount = 3, all leave", () => {
		...
		/* Remove all routes */
		applyPerRouteHeads([]);
		const linksAfter = mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/shared.css");
	...
	it("route exits then re-enters with same stylesheet", () => {
		...
		expect(mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/theme.css")).toHaveLength(1);

		/* Route leaves */
		applyPerRouteHeads([]);
		expect(mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/theme.css")).toHaveLength(0);
	...
	it("two routes share stylesheet, one leaves — element persists", () => {
		...
		/* One element */
		expect(mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/common.css")).toHaveLength(1);
		...
		/* r2 leaves */
		applyPerRouteHeads([]);
		expect(mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/common.css")).toHaveLength(0);
	});
});
...
describe("CSS lifecycle: layout persistence across children", () => {
	it("layout head.css persists when navigating between children", () => {
		...
		expect(mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/layout.css")).toHaveLength(1);
		...
		expect(mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/layout.css")).toHaveLength(1);
		expect(mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/child-b.css")).toHaveLength(1);
		...
		expect(mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/layout.css")).toHaveLength(1);
		expect(mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/child-b.css")).toHaveLength(0);
	});
	...
	it("layout head.css + child head.css — both tracked, child removed on nav", () => {
		...
		expect(mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/layout.css")).toHaveLength(1);
		expect(mockDoc.elements.filter((e) => e.tag === "link" && e.attrs.href === "/child.css")).toHaveLength(0);
	});
});
