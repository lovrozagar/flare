...
export const categorySegment = createPathSegment("_root_/(path-segment-test)/path-segment-test/[category]");
...
export const route = createPage("_root_/(path-segment-test)/path-segment-test/[category]/detail")
	...
	.render((props) => (
		<main data-testid="path-seg-detail">
			...
			<Link data-testid="link-to-music" params={{ category: "music" }} to="/path-segment-test/[category]/detail">
				Music
			</Link>
			<Link data-testid="link-to-books" params={{ category: "books" }} to="/path-segment-test/[category]/detail">
				Books
			</Link>
		</main>
	));
