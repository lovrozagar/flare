	...
	.render(() => (
		<main data-testid="cls-test">
			...
			<div data-testid="with-fallback" style={{ "font-family": interReal.fontFamily }}>
				<p>
					The quick brown fox jumps over the lazy dog. This paragraph uses Inter with fallback
					metrics. When the real font loads, there should be zero layout shift because the fallback
					font has been size-adjusted to match Inter's metrics exactly.
				</p>
				<p>
			...
			<div data-testid="without-fallback" style={{ "font-family": interNoFallback.fontFamily }}>
				<p>
					The quick brown fox jumps over the lazy dog. This paragraph uses Inter WITHOUT fallback
					metrics. When the real font loads, there may be layout shift because the browser uses a
					default fallback font that doesn't match Inter's dimensions.
				</p>
				<p>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt
					ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
