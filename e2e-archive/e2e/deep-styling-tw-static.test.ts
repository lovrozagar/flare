...
/* styles() tw: token compile is not in the current sx pipeline. */
test.describe.skip("TW static in styles(): flex + css merge", () => {
...
test.describe.skip("TW static in styles(): color + bold + underline", () => {
...
test.describe.skip("TW static + state selectors", () => {
...
test.describe.skip("TW static + vars", () => {
...
test.describe.skip("TW static: isolation", () => {
...
test.describe.skip("TW static: SPA round-trip", () => {
...
test.describe.skip("TW static: hydration no dup", () => {
...
test.describe.skip("TW static: console clean", () => {
