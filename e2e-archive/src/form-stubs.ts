/* Client-safe stubs for <Form> action props.
 * Can't import from ./server-fns at module scope because it chains
 * to node:async_hooks. Stubs only need _registration metadata —
 * actual handlers run server-side via HTTP. */
