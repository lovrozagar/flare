	...
	.render(() => (
		<main data-testid="cls-mono-test">
			...
			<div data-testid="mono-with-fallback" style={{ "font-family": firaCodeReal.fontFamily }}>
				<p>
					The quick brown fox jumps over the lazy dog. This paragraph uses Fira Code with fallback
					metrics. When the real font loads, there should be zero layout shift because the fallback
					font (Courier New) has been size-adjusted to match Fira Code's metrics exactly.
				</p>
				<p>
			...
			<div
				data-testid="mono-without-fallback"
				style={{ "font-family": firaCodeNoFallback.fontFamily }}
			>
				<p>
					The quick brown fox jumps over the lazy dog. This paragraph uses Fira Code WITHOUT
					fallback metrics. When the real font loads, there may be layout shift because the browser
					uses a default fallback font that doesn't match Fira Code's dimensions.
				</p>
				<p>
					Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt
					ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation
