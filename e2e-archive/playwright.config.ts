...
export default defineConfig({
	...
	projects: [
		/* dev projects — all browsers */
		{
			...
			/* consumer-deploy boots sibling runtime apps — Phase 3.a.2, not default proof */
			testIgnore: [
				"**/@prod-only/**",
				"**/deep-styling-sx-prod.test.ts",
				"**/consumer-deploy.test.ts",
			],
			use: {
		...
		},
		{
			name: "firefox-dev",
			grepInvert: /@prod-only/,
			testIgnore: [...CHROMIUM_ONLY_TESTS, "**/@prod-only/**", "**/consumer-deploy.test.ts"],
			use: {
